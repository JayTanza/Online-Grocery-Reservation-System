...
echo $uniqueCode; // Outputs a random 8-character code
...
<head>
   ...
   <title>Online Grocerry Reservation System</title>
...
<section class="containery">
    <div class="slider-wrapper">
        <div class="slider">
            <img id="slide1" src="images/Sliderimg1.png" alt="">
            <img id="slide2" src="images/Sliderimg2.png" alt="">
            <img id="slide3" src="images/Sliderimg3.png" alt="">
            <img id="slide4" src="images/Sliderimg4.png" alt="">
            <img id="slide5" src="images/Sliderimg5.png" alt="">
        </div>
...
<section id="menu" class="menu">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="stock">Stock:<?= $fetch_products['price'] ?>/-</div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/Aboutusbg1.jpg" alt="">
         <h3>Korean Street Food Warriors</h3>
         <p>Shop smarter, not harder - with our grocery shopping system, you can spend less time in the store and more time enjoying life's moments.!</p>
         <a href="#menu" class="btn">OUR PRODUCT</a>
      </div>

      <div class="box">
         <img src="images/Aboutusbg2.jpg" alt="">
         <h3>Live,Love,Eat Healty</h3>
         <p>Bringing convenience to your doorstep - our grocery shopping system is the easy and hassle-free way to get everything you need without leaving home.!</p>
         <a href="#menu" class="btn">OUR PRODUCT</a>
      </div>

      <div class="box">
         <img src="images/Aboutusbg3.jpg" alt="">
         <h3>share with freinds</h3>
         <p>Experience the difference with our grocery shopping system with your friends - where quality, affordability, and convenience meet to make your life easier.!</p>
         <a href="#menu" class="btn">OUR PRODUCT</a>
      </div>
   ...
   <?php
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" class="box" required placeholder="enter your number" min="0" max="9999999999" onkeypress="if(this.value.length == 11) return false;">
         </div>
         <div class="inputBox">
            <span>Reservation Code</span>
            
            <?php
            $uniqueCode = generateUniqueCode(); // assuming you have defined the generateUniqueCode function

            // Display the unique code as a placeholder in an input tag
            echo '<input type="text" name="unique_code" placeholder="' . $uniqueCode . '" maxlength="20">';
            ?>
         </div>
         <div class="inputBox">
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>Bobords@gmail.com</p>
         <p>Bobords2@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>BOBORDS CAPSTONE INC.</span> | all rights reserved!
   </div>
